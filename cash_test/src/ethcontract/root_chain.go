...
// ChallengeAfter is a paid mutator transaction binding the contract method 0x47387d8f.
//
// Solidity: function challengeAfter(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes) returns()
func (_RootChain *RootChainTransactor) ChallengeAfter(opts *bind.TransactOpts, slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte) (*types.Transaction, error) {
	return _RootChain.contract.Transact(opts, "challengeAfter", slot, challengingBlockNumber, challengingTransaction, proof)
}

// ChallengeAfter is a paid mutator transaction binding the contract method 0x47387d8f.
//
// Solidity: function challengeAfter(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes) returns()
func (_RootChain *RootChainSession) ChallengeAfter(slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte) (*types.Transaction, error) {
	return _RootChain.Contract.ChallengeAfter(&_RootChain.TransactOpts, slot, challengingBlockNumber, challengingTransaction, proof)
}

// ChallengeAfter is a paid mutator transaction binding the contract method 0x47387d8f.
//
// Solidity: function challengeAfter(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes) returns()
func (_RootChain *RootChainTransactorSession) ChallengeAfter(slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte) (*types.Transaction, error) {
	return _RootChain.Contract.ChallengeAfter(&_RootChain.TransactOpts, slot, challengingBlockNumber, challengingTransaction, proof)
}

// ChallengeBefore is a paid mutator transaction binding the contract method 0xa362dbc1.
//
// Solidity: function challengeBefore(slot uint64, prevTxBytes bytes, exitingTxBytes bytes, prevTxInclusionProof bytes, exitingTxInclusionProof bytes, sig bytes, prevTxIncBlock uint256, exitingTxIncBlock uint256) returns()
func (_RootChain *RootChainTransactor) ChallengeBefore(opts *bind.TransactOpts, slot uint64, prevTxBytes []byte, exitingTxBytes []byte, prevTxInclusionProof []byte, exitingTxInclusionProof []byte, sig []byte, prevTxIncBlock *big.Int, exitingTxIncBlock *big.Int) (*types.Transaction, error) {
	return _RootChain.contract.Transact(opts, "challengeBefore", slot, prevTxBytes, exitingTxBytes, prevTxInclusionProof, exitingTxInclusionProof, sig, prevTxIncBlock, exitingTxIncBlock)
}

// ChallengeBefore is a paid mutator transaction binding the contract method 0xa362dbc1.
//
// Solidity: function challengeBefore(slot uint64, prevTxBytes bytes, exitingTxBytes bytes, prevTxInclusionProof bytes, exitingTxInclusionProof bytes, sig bytes, prevTxIncBlock uint256, exitingTxIncBlock uint256) returns()
func (_RootChain *RootChainSession) ChallengeBefore(slot uint64, prevTxBytes []byte, exitingTxBytes []byte, prevTxInclusionProof []byte, exitingTxInclusionProof []byte, sig []byte, prevTxIncBlock *big.Int, exitingTxIncBlock *big.Int) (*types.Transaction, error) {
	return _RootChain.Contract.ChallengeBefore(&_RootChain.TransactOpts, slot, prevTxBytes, exitingTxBytes, prevTxInclusionProof, exitingTxInclusionProof, sig, prevTxIncBlock, exitingTxIncBlock)
}

// ChallengeBefore is a paid mutator transaction binding the contract method 0xa362dbc1.
//
// Solidity: function challengeBefore(slot uint64, prevTxBytes bytes, exitingTxBytes bytes, prevTxInclusionProof bytes, exitingTxInclusionProof bytes, sig bytes, prevTxIncBlock uint256, exitingTxIncBlock uint256) returns()
func (_RootChain *RootChainTransactorSession) ChallengeBefore(slot uint64, prevTxBytes []byte, exitingTxBytes []byte, prevTxInclusionProof []byte, exitingTxInclusionProof []byte, sig []byte, prevTxIncBlock *big.Int, exitingTxIncBlock *big.Int) (*types.Transaction, error) {
	return _RootChain.Contract.ChallengeBefore(&_RootChain.TransactOpts, slot, prevTxBytes, exitingTxBytes, prevTxInclusionProof, exitingTxInclusionProof, sig, prevTxIncBlock, exitingTxIncBlock)
}

// ChallengeBetween is a paid mutator transaction binding the contract method 0x728778b5.
//
// Solidity: function challengeBetween(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes) returns()
func (_RootChain *RootChainTransactor) ChallengeBetween(opts *bind.TransactOpts, slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte) (*types.Transaction, error) {
	return _RootChain.contract.Transact(opts, "challengeBetween", slot, challengingBlockNumber, challengingTransaction, proof)
}

// ChallengeBetween is a paid mutator transaction binding the contract method 0x728778b5.
//
// Solidity: function challengeBetween(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes) returns()
func (_RootChain *RootChainSession) ChallengeBetween(slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte) (*types.Transaction, error) {
	return _RootChain.Contract.ChallengeBetween(&_RootChain.TransactOpts, slot, challengingBlockNumber, challengingTransaction, proof)
}

// ChallengeBetween is a paid mutator transaction binding the contract method 0x728778b5.
//
// Solidity: function challengeBetween(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes) returns()
func (_RootChain *RootChainTransactorSession) ChallengeBetween(slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte) (*types.Transaction, error) {
	return _RootChain.Contract.ChallengeBetween(&_RootChain.TransactOpts, slot, challengingBlockNumber, challengingTransaction, proof)
}
...
// GetBlockRoot is a paid mutator transaction binding the contract method 0xe41a5d17.
//
// Solidity: function getBlockRoot(blockNumber uint256) returns(root bytes32)
func (_RootChain *RootChainTransactor) GetBlockRoot(opts *bind.TransactOpts, blockNumber *big.Int) (*types.Transaction, error) {
	return _RootChain.contract.Transact(opts, "getBlockRoot", blockNumber)
}

// GetBlockRoot is a paid mutator transaction binding the contract method 0xe41a5d17.
//
// Solidity: function getBlockRoot(blockNumber uint256) returns(root bytes32)
func (_RootChain *RootChainSession) GetBlockRoot(blockNumber *big.Int) (*types.Transaction, error) {
	return _RootChain.Contract.GetBlockRoot(&_RootChain.TransactOpts, blockNumber)
}

// GetBlockRoot is a paid mutator transaction binding the contract method 0xe41a5d17.
//
// Solidity: function getBlockRoot(blockNumber uint256) returns(root bytes32)
func (_RootChain *RootChainTransactorSession) GetBlockRoot(blockNumber *big.Int) (*types.Transaction, error) {
	return _RootChain.Contract.GetBlockRoot(&_RootChain.TransactOpts, blockNumber)
}
...
// RespondChallengeBefore is a paid mutator transaction binding the contract method 0xe0c45c33.
//
// Solidity: function respondChallengeBefore(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes) returns()
func (_RootChain *RootChainTransactor) RespondChallengeBefore(opts *bind.TransactOpts, slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte) (*types.Transaction, error) {
	return _RootChain.contract.Transact(opts, "respondChallengeBefore", slot, challengingBlockNumber, challengingTransaction, proof)
}

// RespondChallengeBefore is a paid mutator transaction binding the contract method 0xe0c45c33.
//
// Solidity: function respondChallengeBefore(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes) returns()
func (_RootChain *RootChainSession) RespondChallengeBefore(slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte) (*types.Transaction, error) {
	return _RootChain.Contract.RespondChallengeBefore(&_RootChain.TransactOpts, slot, challengingBlockNumber, challengingTransaction, proof)
}

// RespondChallengeBefore is a paid mutator transaction binding the contract method 0xe0c45c33.
//
// Solidity: function respondChallengeBefore(slot uint64, challengingBlockNumber uint256, challengingTransaction bytes, proof bytes) returns()
func (_RootChain *RootChainTransactorSession) RespondChallengeBefore(slot uint64, challengingBlockNumber *big.Int, challengingTransaction []byte, proof []byte) (*types.Transaction, error) {
	return _RootChain.Contract.RespondChallengeBefore(&_RootChain.TransactOpts, slot, challengingBlockNumber, challengingTransaction, proof)
}
...
func (_RootChain *RootChainTransactor) SetERC721(opts *bind.TransactOpts, _erc721 common.Address) (*types.Transaction, error) {
	return _RootChain.contract.Transact(opts, "setERC721", _erc721)
}

// SetERC721 is a paid mutator transaction binding the contract method 0x094144a5.
//
// Solidity: function setERC721(_erc721 address) returns()
func (_RootChain *RootChainSession) SetERC721(_erc721 common.Address) (*types.Transaction, error) {
	return _RootChain.Contract.SetERC721(&_RootChain.TransactOpts, _erc721)
}

// SetERC721 is a paid mutator transaction binding the contract method 0x094144a5.
//
// Solidity: function setERC721(_erc721 address) returns()
func (_RootChain *RootChainTransactorSession) SetERC721(_erc721 common.Address) (*types.Transaction, error) {
	return _RootChain.Contract.SetERC721(&_RootChain.TransactOpts, _erc721)
}

// StartExit is a paid mutator transaction binding the contract method 0x5b6a6efb.
//
// Solidity: function startExit(slot uint64, prevTxBytes bytes, exitingTxBytes bytes, prevTxInclusionProof bytes, exitingTxInclusionProof bytes, sig bytes, prevTxIncBlock uint256, exitingTxIncBlock uint256) returns()
func (_RootChain *RootChainTransactor) StartExit(opts *bind.TransactOpts, slot uint64, prevTxBytes []byte, exitingTxBytes []byte, prevTxInclusionProof []byte, exitingTxInclusionProof []byte, sig []byte, prevTxIncBlock *big.Int, exitingTxIncBlock *big.Int) (*types.Transaction, error) {
	return _RootChain.contract.Transact(opts, "startExit", slot, prevTxBytes, exitingTxBytes, prevTxInclusionProof, exitingTxInclusionProof, sig, prevTxIncBlock, exitingTxIncBlock)
}

// StartExit is a paid mutator transaction binding the contract method 0x5b6a6efb.
//
// Solidity: function startExit(slot uint64, prevTxBytes bytes, exitingTxBytes bytes, prevTxInclusionProof bytes, exitingTxInclusionProof bytes, sig bytes, prevTxIncBlock uint256, exitingTxIncBlock uint256) returns()
func (_RootChain *RootChainSession) StartExit(slot uint64, prevTxBytes []byte, exitingTxBytes []byte, prevTxInclusionProof []byte, exitingTxInclusionProof []byte, sig []byte, prevTxIncBlock *big.Int, exitingTxIncBlock *big.Int) (*types.Transaction, error) {
	return _RootChain.Contract.StartExit(&_RootChain.TransactOpts, slot, prevTxBytes, exitingTxBytes, prevTxInclusionProof, exitingTxInclusionProof, sig, prevTxIncBlock, exitingTxIncBlock)
}

// StartExit is a paid mutator transaction binding the contract method 0x5b6a6efb.
//
// Solidity: function startExit(slot uint64, prevTxBytes bytes, exitingTxBytes bytes, prevTxInclusionProof bytes, exitingTxInclusionProof bytes, sig bytes, prevTxIncBlock uint256, exitingTxIncBlock uint256) returns()
func (_RootChain *RootChainTransactorSession) StartExit(slot uint64, prevTxBytes []byte, exitingTxBytes []byte, prevTxInclusionProof []byte, exitingTxInclusionProof []byte, sig []byte, prevTxIncBlock *big.Int, exitingTxIncBlock *big.Int) (*types.Transaction, error) {
	return _RootChain.Contract.StartExit(&_RootChain.TransactOpts, slot, prevTxBytes, exitingTxBytes, prevTxInclusionProof, exitingTxInclusionProof, sig, prevTxIncBlock, exitingTxIncBlock)
}
